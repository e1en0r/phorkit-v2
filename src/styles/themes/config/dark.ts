...
export const darkTheme = {
  colors: {
    accent: {
      ...
      ghost: chroma(baseColors.primary).brighten(0.75).shade(0.97).hex(),
    ...
    success: {
      ...
      ghost: chroma(baseColors.success).brighten(0.75).shade(0.97).hex(),
    ...
    warning: {
      ...
      ghost: chroma(baseColors.warning).brighten(0.75).shade(0.97).hex(),
    ...
    error: {
      ...
      ghost: chroma(baseColors.error).brighten(0.75).shade(0.97).hex(),
    ...
    neutral: {
      ...
      ghost: chroma(baseColors.neutral).brighten(0.75).shade(0.97).hex(),
